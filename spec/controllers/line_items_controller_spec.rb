...
describe LineItemsController do
  ...
  describe "POST create" do
    ...
    describe "with valid params" do
      xit "creates a new LineItem" do
        expect {
          post :create, {:line_item => valid_attributes,:item_id =>@item.id}, valid_session
        }.to change(LineItem, :count).by(1)
      end

      xit "assigns a newly created line_item as @line_item" do
        post :create, {:line_item => valid_attributes}, valid_session,item_id: @item.id
        assigns(:line_item).should be_a(LineItem)
        assigns(:line_item).should be_persisted
      end

      xit "redirects to the created line_item" do
    ...
    describe "with invalid params" do
      xit "assigns a newly created but unsaved line_item as @line_item" do
  ...
  describe "DELETE destroy" do
    ...
    xit "redirects to the line_items list" do
      line_item = LineItem.create! valid_attributes
      delete :destroy, {:id => line_item.to_param}, valid_session
