...
describe Item do
  ...
  context "Validations" do
    ...
    describe "when price is number" do
      before { item.price = 1 }
      it { should be_valid }
    end
    ...
    describe "when sold_count is integer" do
      before { item.sold_count = 2 }
      it { should be_valid }
    end

    describe "when sold_count is float" do
      before { item.sold_count = 2.2332 }
      it { should_not be_valid }
    end
    ...
    describe "when featured is present" do
      before { item.featured = true }
      it { should be_valid }
    end
